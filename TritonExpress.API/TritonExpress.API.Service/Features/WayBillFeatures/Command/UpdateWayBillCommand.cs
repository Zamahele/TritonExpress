...
{
    public class UpdateWayBillCommand: WayBill,IRequest<WayBill>
    {
        public class UpdateWayBillCopmmanHandler : IRequestHandler<UpdateWayBillCommand, WayBill>
        {
            ...
            public async Task<WayBill> Handle(UpdateWayBillCommand request, CancellationToken cancellationToken)
            {
